export async function loadLocationPage() {
  const mapContainer = document.querySelector(".map-container"); // Use the correct selector with #
  var mapElement = await document.createElement("iframe"); // Declare mapElement variable
  mapElement.src =
